...
router.get('/:vaultId/snapshot', async (req, res) => {
    ...
    try {
        ...
        res.json({
            ...
            weekly: parseFloat(averageDailyReturn * 7).toFixed(2),
            monthly: parseFloat(averageDailyReturn * 30.4375).toFixed(2),
...
router.get('/:vaultId/user-snapshot', authenticateToken, async (req, res) => {
    ...
    try {
        ...
        // --- THE FIX: Calculate P&L and Principal from their true sources ---
