...
router.get('/:vaultId', authenticateToken, async (req, res) => {
  ...
  try {
    const [
      ...
      openTradesResult,
      userLedgerResult,
      farmingProtocolsResult, // This was always here
      buybackGainsResult,
      xpGainsResult
    ] = await Promise.all([
      ...
      // This query is essential for the FarmingVaultView
